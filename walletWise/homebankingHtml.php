            ...
            <div>
               ...
               <div class="newGoal">
                  ...
                  <form class="goalForm" method="post" action="php/savingsGoals.php">
                     ...
                     <div class="form__div">
                        <input type="text" style='width: 10vw; height: 2vh'class="form__input" placeholder=" ">
                     <label class="form__label" >Goal name</label>
                     </div>
                     
                     <p> <?php echo $a ?></p>
                  <input type="textarea" placeholder="Goal descasnt" class="goalMonthlyAmount">
                  <input type="number" placeholder="G class="go>
