      ...
      <div class="section home">
         ...
         <div class="content">
            <div class="left-div">
               ...
               <div class="ss-summary-item ss-highlight top-left" style="flex: none !important;">
                  <span class="ss-summary-saldo">Balance</span>
                  <strong id="ss-final-balance" class="ss-saldo-finale">€
            ...
            <div class="right-div">
               <div class="container">
                  <h1 style="text-align: center;">Balance Trend
                     <?php echo htmlspecialchars($cardId); ?>
                  </h1>
